...
import com.example.Tbank_fj_2024_COURSE_RROJECT.external.omdb.OmdbMovieResponse;
import com.example.Tbank_fj_2024_COURSE_RROJECT.external.omdb.OmdbSearchResult;
import com.example.Tbank_fj_2024_COURSE_RROJECT.external.omdb.OmdbMovie;
...
public class OmdbService {
    ...
    private List<Movie> mapOmdbSearchResultToMovies(OmdbSearchResult searchResult) {
        ...
        for (OmdbMovie omdbMovie : searchResult.getSearch()) {
            ...
            // Устанавливаем значение director по умолчанию для фильмов из поиска
