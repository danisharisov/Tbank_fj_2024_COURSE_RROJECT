...
@Component
public class CancelFriendRequestCommand implements Command {
    ...
    public void execute(String chatId, List<String> args) {
        ...
        if (currentUser != null) {
            friendshipService.cancelFriendRequest(currentUser.getUsername(), sessionService.getContext(chatId));
            messageSender.sendMessage(chatId, "Запрос в друзья для " + sessionService.getContext(chatId) + " отменен.");
